...
public class JefeFinal : MonoBehaviour
{
    ...
    private IEnumerator Embestida()
    {
        ...
        float velocidadEmbestida = -10f; // Ajusta la velocidad de la embestida seg�n tus necesidades
    ...
    {
        float tiempoMovimiento = 3f; // Ajusta la duraci�n del movimiento seg�n tus necesidades
        float tiempoInicio = Time.time;
        ...
        // Mover hacia la posici�n inicial
        tiempoInicio = Time.time;
        while (Time.time < tiempoInicio + tiempoMovimiento / 2)
        {
    ...
    {
        // Actualiza el estado actual seg�n las probabilidades y condiciones que desees
        // Puedes usar Random.Range para generar n�meros aleatorios y decidir el siguiente estado
